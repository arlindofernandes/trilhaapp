...
class _TarefaPageState extends State<TarefaPage> {
  late TarefaHRepository tarefaRepository;
  var _tarefas = const <TarefasModel>[];
  ...
  void obterTarefas() async {
    tarefaRepository = await TarefaHRepository.carregar();
                ...
                builder: (BuildContext bc) {
                  return AlertDialog(
                    ...
                    actions: [
                      ...
                      TextButton(
                          onPressed: () async {
                            await tarefaRepository.salvar(TarefasModel.create(
